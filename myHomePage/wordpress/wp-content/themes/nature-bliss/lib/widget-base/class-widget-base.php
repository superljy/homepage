 ...
 * @since 1.0.0
 */
class Nature_Bliss_Widget_Base extends WP_Widget {
		...
		switch ( $field_type ) {
			...
			case 'image':
				...
				<div>
					...
					<input type="button" class="select-img button button-primary" value="<?php esc_attr_e( 'Upload', 'nature-bliss' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Image', 'nature-bliss' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'nature-bliss' ); ?>" />
					<?php
					$image_status = false;
					if ( ! empty( $value ) ) {
						$image_status = true;
					...
					?>
					<input type="button" value="<?php echo esc_attr_x( 'X', 'Remove Button', 'nature-bliss' ); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr( $remove_button_style ); ?>" />
