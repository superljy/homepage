 ...
 * @since 1.0.0
 */
class Nature_Bliss_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'nature_bliss';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'nature-bliss' ), $i ),
...
// Initialize.
$nature_bliss_footer_widgets = new Nature_Bliss_Footer_Widgets();
